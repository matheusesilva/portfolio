...
const translations = {
  ...
  jp: {
    ...
    aboutTitle: "概要",
    aboutText:
      "私は現在、バックエンド開発分野へのキャリア転換を進めております。これまでのコンサルティング業務で培った分析的・戦略的な思考力と高い責任感を基盤に、常に新しい技術の習得と継続的な成長を心がけています。現在は、Spring Bootを用いたJava API開発に注力しながら、ソフトウェアエンジニアリング分野のMBA課程を修了しております。",
    skillsTitle: "スキル",
